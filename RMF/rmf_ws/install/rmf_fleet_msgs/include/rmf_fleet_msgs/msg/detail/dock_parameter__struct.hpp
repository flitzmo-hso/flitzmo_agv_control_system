...
struct DockParameter_
{
  ...
  _finish_type finish;
  using _path_type =
    std::vector<rmf_fleet_msgs::msg::Location_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_fleet_msgs::msg::Location_<ContainerAllocator>>::other>;
  _path_type path;
  ...
  Type & set__path(
    const std::vector<rmf_fleet_msgs::msg::Location_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_fleet_msgs::msg::Location_<ContainerAllocator>>::other> & _arg)
  {
    this->path = _arg;
    return *this;
  }
