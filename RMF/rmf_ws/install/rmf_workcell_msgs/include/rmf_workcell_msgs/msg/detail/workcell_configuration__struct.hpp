...
struct WorkcellConfiguration_
{
  ...
  _type_type type;
  using _assets_type =
    std::vector<rmf_workcell_msgs::msg::Asset_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_workcell_msgs::msg::Asset_<ContainerAllocator>>::other>;
  _assets_type assets;
  using _traits_type =
    std::vector<rmf_workcell_msgs::msg::Trait_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_workcell_msgs::msg::Trait_<ContainerAllocator>>::other>;
  _traits_type traits;
  ...
  Type & set__assets(
    const std::vector<rmf_workcell_msgs::msg::Asset_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_workcell_msgs::msg::Asset_<ContainerAllocator>>::other> & _arg)
  {
    this->assets = _arg;
    return *this;
  }
  Type & set__traits(
    const std::vector<rmf_workcell_msgs::msg::Trait_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_workcell_msgs::msg::Trait_<ContainerAllocator>>::other> & _arg)
  {
    this->traits = _arg;
    return *this;
  }
