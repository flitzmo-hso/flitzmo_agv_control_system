...
class Init_ItineraryDelay_from_time
{
public:
  explicit Init_ItineraryDelay_from_time(::rmf_traffic_msgs::msg::ItineraryDelay & msg)
  : msg_(msg)
  {}
  Init_ItineraryDelay_delay from_time(::rmf_traffic_msgs::msg::ItineraryDelay::_from_time_type arg)
  {
    msg_.from_time = std::move(arg);
...
public:
  ...
  {}
  Init_ItineraryDelay_from_time participant(::rmf_traffic_msgs::msg::ItineraryDelay::_participant_type arg)
  {
    msg_.participant = std::move(arg);
    return Init_ItineraryDelay_from_time(msg_);
  }
