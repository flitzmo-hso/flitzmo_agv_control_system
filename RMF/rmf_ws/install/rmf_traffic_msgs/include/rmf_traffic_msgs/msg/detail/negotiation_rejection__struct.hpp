...
struct NegotiationRejection_
{
  ...
  using _alternatives_type =
    std::vector<rmf_traffic_msgs::msg::Itinerary_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::Itinerary_<ContainerAllocator>>::other>;
  ...
  Type & set__alternatives(
    const std::vector<rmf_traffic_msgs::msg::Itinerary_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::Itinerary_<ContainerAllocator>>::other> & _arg)
  {
