...
void Place__rosidl_typesupport_introspection_c__Place_init_function(
...
void Place__rosidl_typesupport_introspection_c__Place_fini_function(void * message_memory)
{
  rmf_building_map_msgs__msg__Place__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Place__rosidl_typesupport_introspection_c__Place_message_member_array[6] = {
  {
    "name",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers Place__rosidl_typesupport_introspection_c__Place_message_members = {
  "rmf_building_map_msgs__msg",  // message namespace
  "Place",  // message name
  6,  // number of fields
  sizeof(rmf_building_map_msgs__msg__Place),
  Place__rosidl_typesupport_introspection_c__Place_message_member_array,  // message members
  Place__rosidl_typesupport_introspection_c__Place_init_function,  // function to initialize message memory (memory has to be allocated)
  Place__rosidl_typesupport_introspection_c__Place_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t Place__rosidl_typesupport_introspection_c__Place_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_building_map_msgs, msg, Place)() {
  if (!Place__rosidl_typesupport_introspection_c__Place_message_type_support_handle.typesupport_identifier) {
    Place__rosidl_typesupport_introspection_c__Place_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &Place__rosidl_typesupport_introspection_c__Place_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
