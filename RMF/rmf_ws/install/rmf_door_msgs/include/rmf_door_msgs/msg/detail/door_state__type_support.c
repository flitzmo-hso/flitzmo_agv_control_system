...
static rosidl_typesupport_introspection_c__MessageMember DoorState__rosidl_typesupport_introspection_c__DoorState_message_member_array[3] = {
  {
    "door_time",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_door_msgs, msg, DoorState)() {
  DoorState__rosidl_typesupport_introspection_c__DoorState_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, builtin_interfaces, msg, Time)();
  DoorState__rosidl_typesupport_introspection_c__DoorState_message_member_array[2].members_ =
