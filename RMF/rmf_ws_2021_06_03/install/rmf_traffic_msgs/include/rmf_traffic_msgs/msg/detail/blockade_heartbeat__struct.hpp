...
struct BlockadeHeartbeat_
{
  ...
  using _statuses_type =
    std::vector<rmf_traffic_msgs::msg::BlockadeStatus_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::BlockadeStatus_<ContainerAllocator>>::other>;
  ...
  Type & set__statuses(
    const std::vector<rmf_traffic_msgs::msg::BlockadeStatus_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::BlockadeStatus_<ContainerAllocator>>::other> & _arg)
  {
    this->statuses = _arg;
    return *this;
  }
