...
struct BlockadeSet_
{
  ...
  _radius_type radius;
  using _path_type =
    std::vector<rmf_traffic_msgs::msg::BlockadeCheckpoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::BlockadeCheckpoint_<ContainerAllocator>>::other>;
  _path_type path;
  ...
  Type & set__path(
    const std::vector<rmf_traffic_msgs::msg::BlockadeCheckpoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::BlockadeCheckpoint_<ContainerAllocator>>::other> & _arg)
  {
    this->path = _arg;
    return *this;
  }
