...
struct ScheduleQuerySpacetime_
{
  ...
  _type_type type;
  using _regions_type =
    std::vector<rmf_traffic_msgs::msg::Region_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::Region_<ContainerAllocator>>::other>;
  ...
  Type & set__regions(
    const std::vector<rmf_traffic_msgs::msg::Region_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::Region_<ContainerAllocator>>::other> & _arg)
  {
    this->regions = _arg;
    return *this;
  }
