...
#ifndef RMF_TRAFFIC_MSGS__MSG__DETAIL__TRAJECTORY__FUNCTIONS_H_
#define RMF_TRAFFIC_MSGS__MSG__DETAIL__TRAJECTORY__FUNCTIONS_H_
 ...
 * calls
 * rmf_traffic_msgs__msg__Trajectory__init().
...
/**
 * It calls
 * rmf_traffic_msgs__msg__Trajectory__fini()
 ...
 * rmf_traffic_msgs__msg__Trajectory__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rmf_traffic_msgs__msg__Trajectory__Sequence__fini()
 * on the array,
...
#endif  // RMF_TRAFFIC_MSGS__MSG__DETAIL__TRAJECTORY__FUNCTIONS_H_
