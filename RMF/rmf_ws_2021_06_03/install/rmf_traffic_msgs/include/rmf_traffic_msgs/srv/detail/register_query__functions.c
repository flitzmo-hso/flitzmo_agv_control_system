...
{
  rmf_traffic_msgs__srv__RegisterQuery_Request * msg = (rmf_traffic_msgs__srv__RegisterQuery_Request *)malloc(sizeof(rmf_traffic_msgs__srv__RegisterQuery_Request));
  if (!msg) {
    return NULL;
  }
...
rmf_traffic_msgs__srv__RegisterQuery_Request__Sequence__init(rmf_traffic_msgs__srv__RegisterQuery_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rmf_traffic_msgs__srv__RegisterQuery_Request *)calloc(size, sizeof(rmf_traffic_msgs__srv__RegisterQuery_Request));
    if (!data) {
      return false;
    }
...
{
  rmf_traffic_msgs__srv__RegisterQuery_Request__Sequence * array = (rmf_traffic_msgs__srv__RegisterQuery_Request__Sequence *)malloc(sizeof(rmf_traffic_msgs__srv__RegisterQuery_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  rmf_traffic_msgs__srv__RegisterQuery_Response * msg = (rmf_traffic_msgs__srv__RegisterQuery_Response *)malloc(sizeof(rmf_traffic_msgs__srv__RegisterQuery_Response));
  if (!msg) {
    return NULL;
  }
...
rmf_traffic_msgs__srv__RegisterQuery_Response__Sequence__init(rmf_traffic_msgs__srv__RegisterQuery_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rmf_traffic_msgs__srv__RegisterQuery_Response *)calloc(size, sizeof(rmf_traffic_msgs__srv__RegisterQuery_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rmf_traffic_msgs__srv__RegisterQuery_Response__Sequence * array = (rmf_traffic_msgs__srv__RegisterQuery_Response__Sequence *)malloc(sizeof(rmf_traffic_msgs__srv__RegisterQuery_Response__Sequence));
  if (!array) {
    return NULL;
  }
