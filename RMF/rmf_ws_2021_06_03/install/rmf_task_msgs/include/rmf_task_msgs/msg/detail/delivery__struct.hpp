...
struct Delivery_
{
  ...
  using _items_type =
    std::vector<rmf_dispenser_msgs::msg::DispenserRequestItem_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_dispenser_msgs::msg::DispenserRequestItem_<ContainerAllocator>>::other>;
  _items_type items;
  ...
  Type & set__items(
    const std::vector<rmf_dispenser_msgs::msg::DispenserRequestItem_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_dispenser_msgs::msg::DispenserRequestItem_<ContainerAllocator>>::other> & _arg)
  {
    this->items = _arg;
    return *this;
  }
