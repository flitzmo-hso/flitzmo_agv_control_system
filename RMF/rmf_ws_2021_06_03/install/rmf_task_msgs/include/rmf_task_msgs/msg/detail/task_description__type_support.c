...
void TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_init_function(
...
void TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_fini_function(void * message_memory)
{
  rmf_task_msgs__msg__TaskDescription__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_message_member_array[7] = {
  {
    "start_time",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_message_members = {
  "rmf_task_msgs__msg",  // message namespace
  "TaskDescription",  // message name
  7,  // number of fields
  sizeof(rmf_task_msgs__msg__TaskDescription),
  TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_message_member_array,  // message members
  TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_init_function,  // function to initialize message memory (memory has to be allocated)
  TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_message_type_support_handle = {
  0,
  &TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_task_msgs, msg, TaskDescription)() {
  TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, builtin_interfaces, msg, Time)();
  TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_task_msgs, msg, Priority)();
  TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_task_msgs, msg, TaskType)();
  TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_message_member_array[3].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_task_msgs, msg, Station)();
  TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_message_member_array[4].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_task_msgs, msg, Loop)();
  TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_message_member_array[5].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_task_msgs, msg, Delivery)();
  TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_message_member_array[6].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_task_msgs, msg, Clean)();
  if (!TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_message_type_support_handle.typesupport_identifier) {
    TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &TaskDescription__rosidl_typesupport_introspection_c__TaskDescription_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
