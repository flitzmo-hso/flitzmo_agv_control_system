...
CREATE TABLE `FITTING` (
  ...
  `F_FT_ID` int NOT NULL,
  `F_DESC` varchar(100) NOT NULL,
  `F_ACTIVE` tinyint NOT NULL DEFAULT '1',
  PRIMARY KEY (`F_ID`),
  KEY `F_FT_ID_idx` (`F_FT_ID`),
  CONSTRAINT `F_FT_ID` FOREIGN KEY (`F_FT_ID`) REFERENCES `FITTINGTYPE` (`FT_ID`)
...
INSERT INTO `FITTING` VALUES (1,1,'F1-Platform',1),(2,1,'F1-Platform',1),(3,2,'F1-Fork',1),(4,2,'F1-Fork',1),(5,3,'F1-Arm',1);
