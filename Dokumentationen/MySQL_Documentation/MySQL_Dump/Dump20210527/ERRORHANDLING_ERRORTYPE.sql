...
CREATE TABLE `ERRORTYPE` (
  ...
  `ET_DESC` varchar(100) NOT NULL,
  `ET_ACTIVE` tinyint NOT NULL DEFAULT '1',
  PRIMARY KEY (`ET_ID`),
  UNIQUE KEY `ET_DESC_UNIQUE` (`ET_DESC`)
...
LOCK TABLES `ERRORTYPE` WRITE;
/*!40000 ALTER TABLE `ERRORTYPE` DISABLE KEYS */;
/*!40000 ALTER TABLE `ERRORTYPE` ENABLE KEYS */;
UNLOCK TABLES;
