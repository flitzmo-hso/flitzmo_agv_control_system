...
#ifndef RMF_CHARGER_MSGS__MSG__DETAIL__CHARGER_STATE__FUNCTIONS_H_
#define RMF_CHARGER_MSGS__MSG__DETAIL__CHARGER_STATE__FUNCTIONS_H_
 ...
 * calls
 * rmf_charger_msgs__msg__ChargerState__init().
...
/**
 * It calls
 * rmf_charger_msgs__msg__ChargerState__fini()
 ...
 * rmf_charger_msgs__msg__ChargerState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rmf_charger_msgs__msg__ChargerState__Sequence__fini()
 * on the array,
...
#endif  // RMF_CHARGER_MSGS__MSG__DETAIL__CHARGER_STATE__FUNCTIONS_H_
