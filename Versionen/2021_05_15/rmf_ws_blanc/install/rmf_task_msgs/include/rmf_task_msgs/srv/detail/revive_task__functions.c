...
{
  rmf_task_msgs__srv__ReviveTask_Request * msg = (rmf_task_msgs__srv__ReviveTask_Request *)malloc(sizeof(rmf_task_msgs__srv__ReviveTask_Request));
  if (!msg) {
    return NULL;
  }
...
rmf_task_msgs__srv__ReviveTask_Request__Sequence__init(rmf_task_msgs__srv__ReviveTask_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rmf_task_msgs__srv__ReviveTask_Request *)calloc(size, sizeof(rmf_task_msgs__srv__ReviveTask_Request));
    if (!data) {
      return false;
    }
...
{
  rmf_task_msgs__srv__ReviveTask_Request__Sequence * array = (rmf_task_msgs__srv__ReviveTask_Request__Sequence *)malloc(sizeof(rmf_task_msgs__srv__ReviveTask_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  rmf_task_msgs__srv__ReviveTask_Response * msg = (rmf_task_msgs__srv__ReviveTask_Response *)malloc(sizeof(rmf_task_msgs__srv__ReviveTask_Response));
  if (!msg) {
    return NULL;
  }
...
rmf_task_msgs__srv__ReviveTask_Response__Sequence__init(rmf_task_msgs__srv__ReviveTask_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rmf_task_msgs__srv__ReviveTask_Response *)calloc(size, sizeof(rmf_task_msgs__srv__ReviveTask_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rmf_task_msgs__srv__ReviveTask_Response__Sequence * array = (rmf_task_msgs__srv__ReviveTask_Response__Sequence *)malloc(sizeof(rmf_task_msgs__srv__ReviveTask_Response__Sequence));
  if (!array) {
    return NULL;
  }
