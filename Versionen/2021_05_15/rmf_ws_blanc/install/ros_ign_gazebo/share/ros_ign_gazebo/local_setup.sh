...
: ${AMENT_CURRENT_PREFIX:="/home/flitzmofinal/rmf_ws/install/ros_ign_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ros_ign_gazebo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ros_ign_gazebo/environment/path.sh"
