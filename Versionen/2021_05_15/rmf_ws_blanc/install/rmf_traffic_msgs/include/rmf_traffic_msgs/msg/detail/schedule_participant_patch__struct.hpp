...
struct ScheduleParticipantPatch_
{
  ...
  using _delays_type =
    std::vector<rmf_traffic_msgs::msg::ScheduleChangeDelay_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::ScheduleChangeDelay_<ContainerAllocator>>::other>;
  _delays_type delays;
  using _additions_type =
    std::vector<rmf_traffic_msgs::msg::ScheduleChangeAdd_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::ScheduleChangeAdd_<ContainerAllocator>>::other>;
  ...
  Type & set__delays(
    const std::vector<rmf_traffic_msgs::msg::ScheduleChangeDelay_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::ScheduleChangeDelay_<ContainerAllocator>>::other> & _arg)
  {
    this->delays = _arg;
    return *this;
  }
  Type & set__additions(
    const std::vector<rmf_traffic_msgs::msg::ScheduleChangeAdd_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::ScheduleChangeAdd_<ContainerAllocator>>::other> & _arg)
  {
    this->additions = _arg;
    return *this;
  }
