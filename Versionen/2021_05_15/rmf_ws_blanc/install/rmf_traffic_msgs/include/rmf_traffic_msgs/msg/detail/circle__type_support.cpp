...
{
  new (message_memory) rmf_traffic_msgs::msg::Circle(_init);
}

void Circle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rmf_traffic_msgs::msg::Circle *>(message_memory);
  typed_message->~Circle();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Circle_message_member_array[1] = {
  {
    "radius",  // name
    ...
    offsetof(rmf_traffic_msgs::msg::Circle, radius),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Circle_message_members = {
  ...
  "Circle",  // message name
  1,  // number of fields
  sizeof(rmf_traffic_msgs::msg::Circle),
...
{
  return &::rmf_traffic_msgs::msg::rosidl_typesupport_introspection_cpp::Circle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rmf_traffic_msgs, msg, Circle)() {
  return &::rmf_traffic_msgs::msg::rosidl_typesupport_introspection_cpp::Circle_message_type_support_handle;
}
