  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  rmf_traffic_msgs__msg__Shape__init(message_memory);
}

void Shape__rosidl_typesupport_introspection_c__Shape_fini_function(void * message_memory)
{
  rmf_traffic_msgs__msg__Shape__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Shape__rosidl_typesupport_introspection_c__Shape_message_member_array[2] = {
  {
    ...
    offsetof(rmf_traffic_msgs__msg__Shape, type),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rmf_traffic_msgs__msg__Shape, index),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Shape__rosidl_typesupport_introspection_c__Shape_message_members = {
  ...
  "Shape",  // message name
  2,  // number of fields
  sizeof(rmf_traffic_msgs__msg__Shape),
