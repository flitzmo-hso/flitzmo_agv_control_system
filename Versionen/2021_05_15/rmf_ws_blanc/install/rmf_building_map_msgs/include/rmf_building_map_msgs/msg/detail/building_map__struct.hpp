...
struct BuildingMap_
{
  ...
  _name_type name;
  using _levels_type =
    std::vector<rmf_building_map_msgs::msg::Level_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_building_map_msgs::msg::Level_<ContainerAllocator>>::other>;
  _levels_type levels;
  using _lifts_type =
    std::vector<rmf_building_map_msgs::msg::Lift_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_building_map_msgs::msg::Lift_<ContainerAllocator>>::other>;
  _lifts_type lifts;
  ...
  Type & set__levels(
    const std::vector<rmf_building_map_msgs::msg::Level_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_building_map_msgs::msg::Level_<ContainerAllocator>>::other> & _arg)
  {
    this->levels = _arg;
    return *this;
  }
  Type & set__lifts(
    const std::vector<rmf_building_map_msgs::msg::Lift_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_building_map_msgs::msg::Lift_<ContainerAllocator>>::other> & _arg)
  {
    this->lifts = _arg;
    return *this;
  }
