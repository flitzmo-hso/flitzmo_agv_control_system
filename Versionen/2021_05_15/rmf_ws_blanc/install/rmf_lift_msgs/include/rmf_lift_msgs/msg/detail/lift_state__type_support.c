...
void LiftState__rosidl_typesupport_introspection_c__LiftState_init_function(
...
void LiftState__rosidl_typesupport_introspection_c__LiftState_fini_function(void * message_memory)
{
  rmf_lift_msgs__msg__LiftState__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember LiftState__rosidl_typesupport_introspection_c__LiftState_message_member_array[10] = {
  {
    "lift_time",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers LiftState__rosidl_typesupport_introspection_c__LiftState_message_members = {
  "rmf_lift_msgs__msg",  // message namespace
  "LiftState",  // message name
  10,  // number of fields
  sizeof(rmf_lift_msgs__msg__LiftState),
  LiftState__rosidl_typesupport_introspection_c__LiftState_message_member_array,  // message members
  LiftState__rosidl_typesupport_introspection_c__LiftState_init_function,  // function to initialize message memory (memory has to be allocated)
  LiftState__rosidl_typesupport_introspection_c__LiftState_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t LiftState__rosidl_typesupport_introspection_c__LiftState_message_type_support_handle = {
  0,
  &LiftState__rosidl_typesupport_introspection_c__LiftState_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_lift_msgs, msg, LiftState)() {
  LiftState__rosidl_typesupport_introspection_c__LiftState_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, builtin_interfaces, msg, Time)();
  if (!LiftState__rosidl_typesupport_introspection_c__LiftState_message_type_support_handle.typesupport_identifier) {
    LiftState__rosidl_typesupport_introspection_c__LiftState_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &LiftState__rosidl_typesupport_introspection_c__LiftState_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
