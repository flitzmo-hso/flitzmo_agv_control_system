...
struct IngestorRequest_
{
  ...
  using _items_type =
    std::vector<rmf_ingestor_msgs::msg::IngestorRequestItem_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_ingestor_msgs::msg::IngestorRequestItem_<ContainerAllocator>>::other>;
  _items_type items;
  ...
  Type & set__items(
    const std::vector<rmf_ingestor_msgs::msg::IngestorRequestItem_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_ingestor_msgs::msg::IngestorRequestItem_<ContainerAllocator>>::other> & _arg)
  {
    this->items = _arg;
    return *this;
  }
