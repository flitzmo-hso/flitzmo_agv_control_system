...
struct ModeRequest_
{
  ...
  using _parameters_type =
    std::vector<rmf_fleet_msgs::msg::ModeParameter_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_fleet_msgs::msg::ModeParameter_<ContainerAllocator>>::other>;
  ...
  Type & set__parameters(
    const std::vector<rmf_fleet_msgs::msg::ModeParameter_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_fleet_msgs::msg::ModeParameter_<ContainerAllocator>>::other> & _arg)
  {
