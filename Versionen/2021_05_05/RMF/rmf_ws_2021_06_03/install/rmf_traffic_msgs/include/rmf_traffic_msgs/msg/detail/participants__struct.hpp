...
struct Participants_
{
  ...
  using _participants_type =
    std::vector<rmf_traffic_msgs::msg::Participant_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::Participant_<ContainerAllocator>>::other>;
  _participants_type participants;

  // setters for named parameter idiom
  Type & set__participants(
    const std::vector<rmf_traffic_msgs::msg::Participant_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::Participant_<ContainerAllocator>>::other> & _arg)
  {
