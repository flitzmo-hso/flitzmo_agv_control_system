...
size_t size_function__ScheduleParticipantPatch__additions(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<rmf_traffic_msgs::msg::ScheduleChangeAdd> *>(untyped_member);
  return member->size();
}

const void * get_const_function__ScheduleParticipantPatch__additions(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<rmf_traffic_msgs::msg::ScheduleChangeAdd> *>(untyped_member);
  return &member[index];
}

void * get_function__ScheduleParticipantPatch__additions(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<rmf_traffic_msgs::msg::ScheduleChangeAdd> *>(untyped_member);
  return &member[index];
}

void resize_function__ScheduleParticipantPatch__additions(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<rmf_traffic_msgs::msg::ScheduleChangeAdd> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ScheduleParticipantPatch_message_member_array[5] = {
  {
    "participant_id",  // name
  ...
  },
  {
    ...
    nullptr,  // default value
    size_function__ScheduleParticipantPatch__additions,  // size() function pointer
    get_const_function__ScheduleParticipantPatch__additions,  // get_const(index) function pointer
    get_function__ScheduleParticipantPatch__additions,  // get(index) function pointer
    resize_function__ScheduleParticipantPatch__additions  // resize(index) function pointer
  }
};
