...
struct DoorSessions_
{
  ...
  using _sessions_type =
    std::vector<rmf_door_msgs::msg::Session_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_door_msgs::msg::Session_<ContainerAllocator>>::other>;
  ...
  Type & set__sessions(
    const std::vector<rmf_door_msgs::msg::Session_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_door_msgs::msg::Session_<ContainerAllocator>>::other> & _arg)
  {
    this->sessions = _arg;
    return *this;
  }
