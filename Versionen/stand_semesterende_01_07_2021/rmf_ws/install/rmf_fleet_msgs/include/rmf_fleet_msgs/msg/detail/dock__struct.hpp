...
struct Dock_
{
  ...
  using _params_type =
    std::vector<rmf_fleet_msgs::msg::DockParameter_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_fleet_msgs::msg::DockParameter_<ContainerAllocator>>::other>;
  _params_type params;
  ...
  Type & set__params(
    const std::vector<rmf_fleet_msgs::msg::DockParameter_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_fleet_msgs::msg::DockParameter_<ContainerAllocator>>::other> & _arg)
  {
    this->params = _arg;
    return *this;
  }
