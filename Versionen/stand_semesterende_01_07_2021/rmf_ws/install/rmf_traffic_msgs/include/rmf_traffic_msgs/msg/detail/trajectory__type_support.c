...
size_t Trajectory__rosidl_typesupport_introspection_c__size_function__TrajectoryWaypoint__waypoints(
...
const void * Trajectory__rosidl_typesupport_introspection_c__get_const_function__TrajectoryWaypoint__waypoints(
...
void * Trajectory__rosidl_typesupport_introspection_c__get_function__TrajectoryWaypoint__waypoints(
...
bool Trajectory__rosidl_typesupport_introspection_c__resize_function__TrajectoryWaypoint__waypoints(
...
static rosidl_typesupport_introspection_c__MessageMember Trajectory__rosidl_typesupport_introspection_c__Trajectory_message_member_array[1] = {
  {
    ...
    NULL,  // default value
    Trajectory__rosidl_typesupport_introspection_c__size_function__TrajectoryWaypoint__waypoints,  // size() function pointer
    Trajectory__rosidl_typesupport_introspection_c__get_const_function__TrajectoryWaypoint__waypoints,  // get_const(index) function pointer
    Trajectory__rosidl_typesupport_introspection_c__get_function__TrajectoryWaypoint__waypoints,  // get(index) function pointer
    Trajectory__rosidl_typesupport_introspection_c__resize_function__TrajectoryWaypoint__waypoints  // resize(index) function pointer
  }
};
