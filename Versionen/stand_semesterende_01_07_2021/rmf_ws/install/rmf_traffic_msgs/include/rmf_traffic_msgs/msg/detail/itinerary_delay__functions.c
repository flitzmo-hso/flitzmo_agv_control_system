...
{
  rmf_traffic_msgs__msg__ItineraryDelay * msg = (rmf_traffic_msgs__msg__ItineraryDelay *)malloc(sizeof(rmf_traffic_msgs__msg__ItineraryDelay));
  if (!msg) {
    return NULL;
  }
...
rmf_traffic_msgs__msg__ItineraryDelay__Sequence__init(rmf_traffic_msgs__msg__ItineraryDelay__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rmf_traffic_msgs__msg__ItineraryDelay *)calloc(size, sizeof(rmf_traffic_msgs__msg__ItineraryDelay));
    if (!data) {
      return false;
    }
...
{
  rmf_traffic_msgs__msg__ItineraryDelay__Sequence * array = (rmf_traffic_msgs__msg__ItineraryDelay__Sequence *)malloc(sizeof(rmf_traffic_msgs__msg__ItineraryDelay__Sequence));
  if (!array) {
    return NULL;
  }
