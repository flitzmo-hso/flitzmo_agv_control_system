...
struct NegotiationAck_
{
  ...
  using _acknowledgments_type =
    std::vector<rmf_traffic_msgs::msg::NegotiationParticipantAck_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::NegotiationParticipantAck_<ContainerAllocator>>::other>;
  ...
  Type & set__acknowledgments(
    const std::vector<rmf_traffic_msgs::msg::NegotiationParticipantAck_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::NegotiationParticipantAck_<ContainerAllocator>>::other> & _arg)
  {
