...
struct SupervisorHeartbeat_
{
  ...
  using _all_sessions_type =
    std::vector<rmf_door_msgs::msg::DoorSessions_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_door_msgs::msg::DoorSessions_<ContainerAllocator>>::other>;
  _all_sessions_type all_sessions;

  // setters for named parameter idiom
  Type & set__all_sessions(
    const std::vector<rmf_door_msgs::msg::DoorSessions_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_door_msgs::msg::DoorSessions_<ContainerAllocator>>::other> & _arg)
  {
