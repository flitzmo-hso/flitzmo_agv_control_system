...
{
  rmf_traffic_msgs__msg__Shape * msg = (rmf_traffic_msgs__msg__Shape *)malloc(sizeof(rmf_traffic_msgs__msg__Shape));
  if (!msg) {
    return NULL;
  }
...
rmf_traffic_msgs__msg__Shape__Sequence__init(rmf_traffic_msgs__msg__Shape__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rmf_traffic_msgs__msg__Shape *)calloc(size, sizeof(rmf_traffic_msgs__msg__Shape));
    if (!data) {
      return false;
    }
...
{
  rmf_traffic_msgs__msg__Shape__Sequence * array = (rmf_traffic_msgs__msg__Shape__Sequence *)malloc(sizeof(rmf_traffic_msgs__msg__Shape__Sequence));
  if (!array) {
    return NULL;
  }
