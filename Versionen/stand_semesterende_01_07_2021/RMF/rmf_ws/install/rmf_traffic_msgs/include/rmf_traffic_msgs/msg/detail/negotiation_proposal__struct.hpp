...
struct NegotiationProposal_
{
  ...
  using _itinerary_type =
    std::vector<rmf_traffic_msgs::msg::Route_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::Route_<ContainerAllocator>>::other>;
  ...
  Type & set__itinerary(
    const std::vector<rmf_traffic_msgs::msg::Route_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::Route_<ContainerAllocator>>::other> & _arg)
  {
    this->itinerary = _arg;
    return *this;
  }
