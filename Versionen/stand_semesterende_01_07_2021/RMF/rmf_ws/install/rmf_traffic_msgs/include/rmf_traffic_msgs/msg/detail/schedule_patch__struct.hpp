...
struct SchedulePatch_
{
  ...
  using _participants_type =
    std::vector<rmf_traffic_msgs::msg::ScheduleParticipantPatch_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::ScheduleParticipantPatch_<ContainerAllocator>>::other>;
  _participants_type participants;
  using _cull_type =
    std::vector<rmf_traffic_msgs::msg::ScheduleChangeCull_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::ScheduleChangeCull_<ContainerAllocator>>::other>;
  _cull_type cull;
  ...
  Type & set__participants(
    const std::vector<rmf_traffic_msgs::msg::ScheduleParticipantPatch_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::ScheduleParticipantPatch_<ContainerAllocator>>::other> & _arg)
  {
    this->participants = _arg;
    return *this;
  }
  Type & set__cull(
    const std::vector<rmf_traffic_msgs::msg::ScheduleChangeCull_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::ScheduleChangeCull_<ContainerAllocator>>::other> & _arg)
  {
    this->cull = _arg;
    return *this;
  }
