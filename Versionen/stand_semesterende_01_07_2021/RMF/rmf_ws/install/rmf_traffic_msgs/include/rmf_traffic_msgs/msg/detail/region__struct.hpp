...
struct Region_
{
  ...
  _map_type map;
  using _spaces_type =
    std::vector<rmf_traffic_msgs::msg::Space_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::Space_<ContainerAllocator>>::other>;
  _spaces_type spaces;
  ...
  Type & set__spaces(
    const std::vector<rmf_traffic_msgs::msg::Space_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::Space_<ContainerAllocator>>::other> & _arg)
  {
    this->spaces = _arg;
    return *this;
  }
