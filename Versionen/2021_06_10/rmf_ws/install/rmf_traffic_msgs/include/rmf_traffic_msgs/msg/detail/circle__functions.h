...
#ifndef RMF_TRAFFIC_MSGS__MSG__DETAIL__CIRCLE__FUNCTIONS_H_
#define RMF_TRAFFIC_MSGS__MSG__DETAIL__CIRCLE__FUNCTIONS_H_
 ...
 * )) before or use
 * rmf_traffic_msgs__msg__Circle__create()
 ...
 * calls
 * rmf_traffic_msgs__msg__Circle__init().
...
/**
 * It calls
 * rmf_traffic_msgs__msg__Circle__fini()
 ...
 * rmf_traffic_msgs__msg__Circle__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rmf_traffic_msgs__msg__Circle__Sequence__fini()
 * on the array,
...
#endif  // RMF_TRAFFIC_MSGS__MSG__DETAIL__CIRCLE__FUNCTIONS_H_
