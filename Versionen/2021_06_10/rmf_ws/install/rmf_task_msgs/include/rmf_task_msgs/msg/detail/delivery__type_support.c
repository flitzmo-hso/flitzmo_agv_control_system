...
size_t Delivery__rosidl_typesupport_introspection_c__size_function__DispenserRequestItem__items(
...
const void * Delivery__rosidl_typesupport_introspection_c__get_const_function__DispenserRequestItem__items(
...
void * Delivery__rosidl_typesupport_introspection_c__get_function__DispenserRequestItem__items(
...
bool Delivery__rosidl_typesupport_introspection_c__resize_function__DispenserRequestItem__items(
...
static rosidl_typesupport_introspection_c__MessageMember Delivery__rosidl_typesupport_introspection_c__Delivery_message_member_array[8] = {
  {
    "task_id",  // name
  ...
  },
  {
    ...
    NULL,  // default value
    Delivery__rosidl_typesupport_introspection_c__size_function__DispenserRequestItem__items,  // size() function pointer
    Delivery__rosidl_typesupport_introspection_c__get_const_function__DispenserRequestItem__items,  // get_const(index) function pointer
    Delivery__rosidl_typesupport_introspection_c__get_function__DispenserRequestItem__items,  // get(index) function pointer
    Delivery__rosidl_typesupport_introspection_c__resize_function__DispenserRequestItem__items  // resize(index) function pointer
  },
  {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_task_msgs, msg, Delivery)() {
  ...
  Delivery__rosidl_typesupport_introspection_c__Delivery_message_member_array[4].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_task_msgs, msg, Behavior)();
  Delivery__rosidl_typesupport_introspection_c__Delivery_message_member_array[7].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_task_msgs, msg, Behavior)();
