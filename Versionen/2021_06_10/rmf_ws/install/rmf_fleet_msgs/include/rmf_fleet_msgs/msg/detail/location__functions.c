...
{
  rmf_fleet_msgs__msg__Location * msg = (rmf_fleet_msgs__msg__Location *)malloc(sizeof(rmf_fleet_msgs__msg__Location));
  if (!msg) {
    return NULL;
  }
...
rmf_fleet_msgs__msg__Location__Sequence__init(rmf_fleet_msgs__msg__Location__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rmf_fleet_msgs__msg__Location *)calloc(size, sizeof(rmf_fleet_msgs__msg__Location));
    if (!data) {
      return false;
    }
...
{
  rmf_fleet_msgs__msg__Location__Sequence * array = (rmf_fleet_msgs__msg__Location__Sequence *)malloc(sizeof(rmf_fleet_msgs__msg__Location__Sequence));
  if (!array) {
    return NULL;
  }
