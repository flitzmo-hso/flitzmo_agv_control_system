...
struct Behavior_
{
  ...
  using _parameters_type =
    std::vector<rmf_task_msgs::msg::BehaviorParameter_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_task_msgs::msg::BehaviorParameter_<ContainerAllocator>>::other>;
  ...
  Type & set__parameters(
    const std::vector<rmf_task_msgs::msg::BehaviorParameter_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_task_msgs::msg::BehaviorParameter_<ContainerAllocator>>::other> & _arg)
  {
