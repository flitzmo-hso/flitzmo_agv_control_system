...
{
  rmf_traffic_msgs__msg__Route * msg = (rmf_traffic_msgs__msg__Route *)malloc(sizeof(rmf_traffic_msgs__msg__Route));
  if (!msg) {
    return NULL;
  }
...
rmf_traffic_msgs__msg__Route__Sequence__init(rmf_traffic_msgs__msg__Route__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rmf_traffic_msgs__msg__Route *)calloc(size, sizeof(rmf_traffic_msgs__msg__Route));
    if (!data) {
      return false;
    }
...
{
  rmf_traffic_msgs__msg__Route__Sequence * array = (rmf_traffic_msgs__msg__Route__Sequence *)malloc(sizeof(rmf_traffic_msgs__msg__Route__Sequence));
  if (!array) {
    return NULL;
  }
