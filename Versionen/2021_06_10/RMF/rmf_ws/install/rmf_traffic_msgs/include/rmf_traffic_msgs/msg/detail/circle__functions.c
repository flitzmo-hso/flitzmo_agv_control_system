...
{
  rmf_traffic_msgs__msg__Circle * msg = (rmf_traffic_msgs__msg__Circle *)malloc(sizeof(rmf_traffic_msgs__msg__Circle));
  if (!msg) {
    return NULL;
  }
...
rmf_traffic_msgs__msg__Circle__Sequence__init(rmf_traffic_msgs__msg__Circle__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rmf_traffic_msgs__msg__Circle *)calloc(size, sizeof(rmf_traffic_msgs__msg__Circle));
    if (!data) {
      return false;
    }
...
{
  rmf_traffic_msgs__msg__Circle__Sequence * array = (rmf_traffic_msgs__msg__Circle__Sequence *)malloc(sizeof(rmf_traffic_msgs__msg__Circle__Sequence));
  if (!array) {
    return NULL;
  }
