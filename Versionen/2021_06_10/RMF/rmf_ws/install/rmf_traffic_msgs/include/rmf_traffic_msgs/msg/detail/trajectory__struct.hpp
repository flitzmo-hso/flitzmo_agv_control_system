...
struct Trajectory_
{
  ...
  using _waypoints_type =
    std::vector<rmf_traffic_msgs::msg::TrajectoryWaypoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::TrajectoryWaypoint_<ContainerAllocator>>::other>;
  _waypoints_type waypoints;

  // setters for named parameter idiom
  Type & set__waypoints(
    const std::vector<rmf_traffic_msgs::msg::TrajectoryWaypoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_traffic_msgs::msg::TrajectoryWaypoint_<ContainerAllocator>>::other> & _arg)
  {
    this->waypoints = _arg;
    return *this;
  }
