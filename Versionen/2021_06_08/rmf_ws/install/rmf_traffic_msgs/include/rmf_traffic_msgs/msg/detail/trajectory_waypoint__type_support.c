...
static rosidl_typesupport_introspection_c__MessageMember TrajectoryWaypoint__rosidl_typesupport_introspection_c__TrajectoryWaypoint_message_member_array[3] = {
  {
    "time",  // name
