...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BidNotice_message_member_array[2] = {
  {
    "task_profile",  // name
    ...
    offsetof(rmf_task_msgs::msg::BidNotice, task_profile),  // bytes offset in struct
