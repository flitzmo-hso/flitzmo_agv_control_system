...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DispatchAck_message_member_array[2] = {
  {
    "dispatch_request",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rmf_task_msgs::msg::DispatchRequest>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(rmf_task_msgs::msg::DispatchAck, dispatch_request),  // bytes offset in struct
