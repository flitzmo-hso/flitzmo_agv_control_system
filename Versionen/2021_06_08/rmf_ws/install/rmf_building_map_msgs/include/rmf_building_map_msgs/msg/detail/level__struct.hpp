...
struct Level_
{
  ...
  using _images_type =
    std::vector<rmf_building_map_msgs::msg::AffineImage_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_building_map_msgs::msg::AffineImage_<ContainerAllocator>>::other>;
  _images_type images;
  using _places_type =
    std::vector<rmf_building_map_msgs::msg::Place_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_building_map_msgs::msg::Place_<ContainerAllocator>>::other>;
  _places_type places;
  using _doors_type =
    std::vector<rmf_building_map_msgs::msg::Door_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_building_map_msgs::msg::Door_<ContainerAllocator>>::other>;
  _doors_type doors;
  using _nav_graphs_type =
    std::vector<rmf_building_map_msgs::msg::Graph_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_building_map_msgs::msg::Graph_<ContainerAllocator>>::other>;
  ...
  Type & set__images(
    const std::vector<rmf_building_map_msgs::msg::AffineImage_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_building_map_msgs::msg::AffineImage_<ContainerAllocator>>::other> & _arg)
  {
    this->images = _arg;
    return *this;
  }
  Type & set__places(
    const std::vector<rmf_building_map_msgs::msg::Place_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_building_map_msgs::msg::Place_<ContainerAllocator>>::other> & _arg)
  {
    this->places = _arg;
    return *this;
  }
  Type & set__doors(
    const std::vector<rmf_building_map_msgs::msg::Door_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_building_map_msgs::msg::Door_<ContainerAllocator>>::other> & _arg)
  {
    this->doors = _arg;
    return *this;
  }
  Type & set__nav_graphs(
    const std::vector<rmf_building_map_msgs::msg::Graph_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_building_map_msgs::msg::Graph_<ContainerAllocator>>::other> & _arg)
  {
