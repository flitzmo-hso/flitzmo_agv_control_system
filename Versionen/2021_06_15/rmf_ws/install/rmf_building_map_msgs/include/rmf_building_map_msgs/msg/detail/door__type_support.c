...
void Door__rosidl_typesupport_introspection_c__Door_init_function(
...
void Door__rosidl_typesupport_introspection_c__Door_fini_function(void * message_memory)
{
  rmf_building_map_msgs__msg__Door__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Door__rosidl_typesupport_introspection_c__Door_message_member_array[8] = {
  {
    "name",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers Door__rosidl_typesupport_introspection_c__Door_message_members = {
  "rmf_building_map_msgs__msg",  // message namespace
  "Door",  // message name
  8,  // number of fields
  sizeof(rmf_building_map_msgs__msg__Door),
  Door__rosidl_typesupport_introspection_c__Door_message_member_array,  // message members
  Door__rosidl_typesupport_introspection_c__Door_init_function,  // function to initialize message memory (memory has to be allocated)
  Door__rosidl_typesupport_introspection_c__Door_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t Door__rosidl_typesupport_introspection_c__Door_message_type_support_handle = {
  0,
  &Door__rosidl_typesupport_introspection_c__Door_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_building_map_msgs, msg, Door)() {
  if (!Door__rosidl_typesupport_introspection_c__Door_message_type_support_handle.typesupport_identifier) {
    Door__rosidl_typesupport_introspection_c__Door_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &Door__rosidl_typesupport_introspection_c__Door_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
