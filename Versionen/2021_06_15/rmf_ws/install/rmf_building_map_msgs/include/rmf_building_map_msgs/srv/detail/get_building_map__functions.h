...
#ifndef RMF_BUILDING_MAP_MSGS__SRV__DETAIL__GET_BUILDING_MAP__FUNCTIONS_H_
#define RMF_BUILDING_MAP_MSGS__SRV__DETAIL__GET_BUILDING_MAP__FUNCTIONS_H_
...
/// Initialize srv/GetBuildingMap message.
/**
...
/// Finalize srv/GetBuildingMap message.
/**
...
/// Create srv/GetBuildingMap message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rmf_building_map_msgs__srv__GetBuildingMap_Request__init().
...
/// Destroy srv/GetBuildingMap message.
/**
 * It calls
 * rmf_building_map_msgs__srv__GetBuildingMap_Request__fini()
...
/// Initialize array of srv/GetBuildingMap messages.
/**
...
/// Finalize array of srv/GetBuildingMap messages.
/**
 * It calls
 * rmf_building_map_msgs__srv__GetBuildingMap_Request__fini()
...
/// Create array of srv/GetBuildingMap messages.
/**
 * It allocates the memory for the array and calls
 * rmf_building_map_msgs__srv__GetBuildingMap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetBuildingMap messages.
/**
 * It calls
 * rmf_building_map_msgs__srv__GetBuildingMap_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rmf_building_map_msgs__srv__GetBuildingMap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_building_map_msgs
...
/**
 * It calls
 * rmf_building_map_msgs__srv__GetBuildingMap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_building_map_msgs
...
/**
 * It allocates the memory for the array and calls
 * rmf_building_map_msgs__srv__GetBuildingMap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_building_map_msgs
...
/**
 * It calls
 * rmf_building_map_msgs__srv__GetBuildingMap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RMF_BUILDING_MAP_MSGS__SRV__DETAIL__GET_BUILDING_MAP__FUNCTIONS_H_
