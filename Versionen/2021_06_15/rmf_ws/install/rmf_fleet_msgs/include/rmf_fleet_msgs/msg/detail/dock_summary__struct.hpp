...
struct DockSummary_
{
  ...
  using _docks_type =
    std::vector<rmf_fleet_msgs::msg::Dock_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_fleet_msgs::msg::Dock_<ContainerAllocator>>::other>;
  _docks_type docks;

  // setters for named parameter idiom
  Type & set__docks(
    const std::vector<rmf_fleet_msgs::msg::Dock_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_fleet_msgs::msg::Dock_<ContainerAllocator>>::other> & _arg)
  {
    this->docks = _arg;
    return *this;
  }
