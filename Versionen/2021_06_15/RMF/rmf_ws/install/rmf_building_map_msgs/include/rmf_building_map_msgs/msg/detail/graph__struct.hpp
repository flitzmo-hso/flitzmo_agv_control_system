...
struct Graph_
{
  ...
  using _vertices_type =
    std::vector<rmf_building_map_msgs::msg::GraphNode_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_building_map_msgs::msg::GraphNode_<ContainerAllocator>>::other>;
  _vertices_type vertices;
  using _edges_type =
    std::vector<rmf_building_map_msgs::msg::GraphEdge_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_building_map_msgs::msg::GraphEdge_<ContainerAllocator>>::other>;
  _edges_type edges;
  using _params_type =
  ...
  Type & set__vertices(
    const std::vector<rmf_building_map_msgs::msg::GraphNode_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_building_map_msgs::msg::GraphNode_<ContainerAllocator>>::other> & _arg)
  {
    this->vertices = _arg;
    return *this;
  }
  Type & set__edges(
    const std::vector<rmf_building_map_msgs::msg::GraphEdge_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmf_building_map_msgs::msg::GraphEdge_<ContainerAllocator>>::other> & _arg)
  {
    this->edges = _arg;
    return *this;
  }
