...
#ifndef RMF_TASK_MSGS__SRV__DETAIL__SUBMIT_TASK__FUNCTIONS_H_
#define RMF_TASK_MSGS__SRV__DETAIL__SUBMIT_TASK__FUNCTIONS_H_
...
/// Initialize srv/SubmitTask message.
/**
...
/// Finalize srv/SubmitTask message.
/**
...
/// Create srv/SubmitTask message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rmf_task_msgs__srv__SubmitTask_Request__init().
...
/// Destroy srv/SubmitTask message.
/**
 * It calls
 * rmf_task_msgs__srv__SubmitTask_Request__fini()
...
/// Initialize array of srv/SubmitTask messages.
/**
...
/// Finalize array of srv/SubmitTask messages.
/**
 * It calls
 * rmf_task_msgs__srv__SubmitTask_Request__fini()
...
/// Create array of srv/SubmitTask messages.
/**
 * It allocates the memory for the array and calls
 * rmf_task_msgs__srv__SubmitTask_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SubmitTask messages.
/**
 * It calls
 * rmf_task_msgs__srv__SubmitTask_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rmf_task_msgs__srv__SubmitTask_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_task_msgs
...
/**
 * It calls
 * rmf_task_msgs__srv__SubmitTask_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_task_msgs
...
/**
 * It allocates the memory for the array and calls
 * rmf_task_msgs__srv__SubmitTask_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_task_msgs
...
/**
 * It calls
 * rmf_task_msgs__srv__SubmitTask_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RMF_TASK_MSGS__SRV__DETAIL__SUBMIT_TASK__FUNCTIONS_H_
