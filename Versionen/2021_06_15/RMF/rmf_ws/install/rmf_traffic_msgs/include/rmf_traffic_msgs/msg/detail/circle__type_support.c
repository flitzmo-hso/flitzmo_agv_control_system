  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  rmf_traffic_msgs__msg__Circle__init(message_memory);
}

void Circle__rosidl_typesupport_introspection_c__Circle_fini_function(void * message_memory)
{
  rmf_traffic_msgs__msg__Circle__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Circle__rosidl_typesupport_introspection_c__Circle_message_member_array[1] = {
  {
    "radius",  // name
    ...
    offsetof(rmf_traffic_msgs__msg__Circle, radius),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Circle__rosidl_typesupport_introspection_c__Circle_message_members = {
  ...
  "Circle",  // message name
  1,  // number of fields
  sizeof(rmf_traffic_msgs__msg__Circle),
